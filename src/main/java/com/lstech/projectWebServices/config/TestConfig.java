...
import com.lstech.projectWebServices.entities.Payment;
...
import com.lstech.projectWebServices.repositories.OrderItemRepository;
import com.lstech.projectWebServices.repositories.OrderRepository;
import com.lstech.projectWebServices.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u1 = new User(null, "Lucas Silva", "lucas.dasilva@gmail.com", "988888888", "123456");
		User u2 = new User(null, "Daniela Gomes", "daniela.gomes@gmail.com", "977777777", "123456");
		...
		Payment pay1 = new Payment(null, Instant.parse("2025-01-20T21:53:07Z"), o1);
		o1.setPayment(pay1);
